...
#xmlSource='/home/venturus/downloads/test'
xmlTarget='/samba/anonymous_share/spi/SMTB/SPIB/proc'
...
def getBsonHeight(featureResultNode):
        ...
        height = {
                   ...
                   'LowFail' : heightNode.attrib['LowFail'].strip()
                 }
        return height
...
def getBsonFeatureResult(featureNode):
        ...
        featureResult = {
                            ...
                            'Registration' : getBsonRegistration(featureResultNode),
...
def getBsonFeatures(locationNode):
        ...
        for featureNode in locationNode.iter('Feature'):
                feature = {
                                       'Name' : featureNode.attrib['Name'].strip(),
                                    'LogMode' : featureNode.attrib['LogMode'].strip(),
                                     'Status' : featureNode.attrib['Status'].strip(),
                                         'Id' : featureNode.attrib['Id'].strip(),
                                          'X' : featureNode.attrib['X'].strip(),
                                          'Y' : featureNode.attrib['Y'].strip(),
                     ...
                     'Panel' : {
                                   ...
                                   'PanelRotation' : panel.attrib['PanelRotation'].strip(),
                                       ...
                                       'CycleTime' : panel.attrib['CycleTime'].strip(),
                                        ...
                                        'SRFFName' : panel.find('SRFFName').text.strip(),
...
#tree = ET.parse('/home/venturus/downloads/test/SSBENSOL001785900110.#8.5c15609a.xml')
...
doc = { "name" : "bixao", "object" : {"name" : "bixona"} }
print(doc['object'])
